...
FILE="$HOME/.config/bspwm/polybar/scripts/rofi/colors.rasi"
...
rofi -no-config -no-lazy-grab -show drun -modi drun -theme ~/.config/bspwm/polybar/scripts/rofi/style_3.rasi
